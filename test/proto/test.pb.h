...
namespace fixbug {
class GetFriendListRequset;
class GetFriendListRequsetDefaultTypeInternal;
extern GetFriendListRequsetDefaultTypeInternal _GetFriendListRequset_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriendListRequset* Arena::CreateMaybeMessage<::fixbug::GetFriendListRequset>(Arena*);
...
class GetFriendListRequset :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListRequset) */ {
 public:
  GetFriendListRequset();
  virtual ~GetFriendListRequset();

  GetFriendListRequset(const GetFriendListRequset& from);
  GetFriendListRequset(GetFriendListRequset&& from) noexcept
    : GetFriendListRequset() {
    *this = ::std::move(from);
  }

  inline GetFriendListRequset& operator=(const GetFriendListRequset& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListRequset& operator=(GetFriendListRequset&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListRequset& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListRequset* internal_default_instance() {
    return reinterpret_cast<const GetFriendListRequset*>(
               &_GetFriendListRequset_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(GetFriendListRequset& a, GetFriendListRequset& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListRequset* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListRequset* New() const final {
    return CreateMaybeMessage<GetFriendListRequset>(nullptr);
  }

  GetFriendListRequset* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListRequset>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListRequset& from);
  void MergeFrom(const GetFriendListRequset& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListRequset* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListRequset";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListRequset)
 private:
  class _Internal;
...
// uint32 userid = 1;
inline void GetFriendListRequset::clear_userid() {
  userid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequset::_internal_userid() const {
  return userid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListRequset::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRequset.userid)
  return _internal_userid();
}
inline void GetFriendListRequset::_internal_set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  userid_ = value;
}
inline void GetFriendListRequset::set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRequset.userid)
}
